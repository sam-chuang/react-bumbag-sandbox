...
ReactDOM.render(___EmotionJSX(React.StrictMode, null, ___EmotionJSX(BumbagProvider, null, ___EmotionJSX(Button, null, "Test"))), document.getElementById("root")); // Hot Module Replacement (HMR) - Remove this snippet to remove HMR.
